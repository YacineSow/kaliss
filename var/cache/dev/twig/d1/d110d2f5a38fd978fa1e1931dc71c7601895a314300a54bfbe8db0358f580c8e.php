...
class __TwigTemplate_8ebe668c0b02cf905232c285ec2ff41369403e89aa82fada45fa87438a2425b3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["compte"]) || array_key_exists("compte", $context) ? $context["compte"] : (function () { throw new RuntimeError('Variable "compte" does not exist.', 16, $this->source); })()), "numcompte", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Solde</th>
...
{% endblock %}
", "compte/show.html.twig", "/home/ndeye/totam_kaliss/templates/compte/show.html.twig");
    }
}
