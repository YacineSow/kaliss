...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/usersbloquer'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/usersdebloquer'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
