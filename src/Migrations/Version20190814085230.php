 ...
 */
final class Version20190814085230 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD beneficiaire_id INT DEFAULT NULL, ADD expediteur_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP beneficiaire_id, DROP expediteur_id, DROP user_id');
    }
}
